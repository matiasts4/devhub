...
function seedSwarmData() {
  ...
  db.prepare("INSERT INTO projects (id, name, progress, status) VALUES ('p3', 'Gamma', 15, 'active')").run();

  // Tasks (various statuses for queue counts)
  db.prepare("INSERT INTO tasks (id, project_id, title, status, priority) VALUES ('t1', 'p1', 'Task A', 'pending', 'high')").run();
  db.prepare("INSERT INTO tasks (id, project_id, title, status, priority) VALUES ('t2', 'p1', 'Task B', 'pending', 'medium')").run();
  db.prepare("INSERT INTO tasks (id, project_id, title, status, priority) VALUES ('t3', 'p1', 'Task C', 'in_progress', 'high')").run();
  db.prepare("INSERT INTO tasks (id, project_id, title, status, priority) VALUES ('t4', 'p2', 'Task D', 'in_progress', 'medium')").run();
  db.prepare("INSERT INTO tasks (id, project_id, title, status, priority) VALUES ('t5', 'p2', 'Task E', 'blocked', 'low')").run();
  db.prepare("INSERT INTO tasks (id, project_id, title, status, priority) VALUES ('t6', 'p2', 'Task F', 'completed', 'medium')").run();
  ...
  db.prepare("INSERT INTO agent_registry (agent_id, nombre, modelo_llm, project_id, status, current_task_id, last_heartbeat) VALUES ('agent-1', 'Worker One', 'claude-sonnet-4-6', 'p1', 'working', 't3', ?)").run(now);
  db.prepare("INSERT INTO agent_registry (agent_id, nombre, modelo_llm, project_id, status, current_task_id, last_heartbeat) VALUES ('agent-2', 'Worker Two', 'gpt-4o', 'p2', 'idle', NULL, ?)").run(now);

  // Agent workspaces
  db.prepare("INSERT INTO agent_workspaces (id, project_id, agent_id, repo_root, workspace_path, worktree_path, base_branch, base_commit, status, branch_name, observed_branch, observed_head, current_task_id) VALUES ('w1', 'p1', 'agent-1', '/tmp', '/tmp/ws1', '/tmp/wt1', 'main', 'abc123', 'active', 'feature/auth', 'feature/auth', 'def456', 't3')").run();
  db.prepare("INSERT INTO agent_workspaces (id, project_id, agent_id, repo_root, workspace_path, worktree_path, base_branch, base_commit, status, branch_name, observed_branch, observed_head) VALUES ('w2', 'p2', 'agent-2', '/tmp', '/tmp/ws2', '/tmp/wt2', 'main', 'abc123', 'active', 'main', 'main', 'abc123')").run();
