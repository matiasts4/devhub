...
export async function fetchAntigravityQuota() {
  ...
  try {
    // Check if AGY CLI or config is present locally
    ...
    // Try querying local Antigravity server or proxy endpoint if active
    ...
    // Default active status when AGY environment exists
