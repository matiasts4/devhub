...
const exportGroups = [
  ...
  [
    workspaces,
    'buildPrepareAgentWorkspaceAck buildWorkspaceIntentId prepareAgentWorkspaceLease validatePrepareAgentWorkspaceIdentity createAgentRun updateAgentRunTerminal appendAgentArtifact getAgentRunById getLatestAgentRunForWorkspace getLatestAgentRunForTask resolveAgentRuntimeBinding reconcileAgentRuntimeSessionBinding listAgentRuns listAgentArtifacts getLatestAgentArtifactForRun insertTrace upsertTrace getTracesBySession searchTraces updateTrace insertMessage getMessagesBySession getToolTracesBySession upsertSessionUsage getSessionUsage getTelegramSession createTelegramSession getSessionsByProject getRecentSessions getSessionsByTelegramChat updateSessionStatus updateSessionError updateSessionOpenCodeId provisionAuthToken revokeAuthToken getActiveAuthToken getAgentSecret verifyAuthTokenExists updateWorkspacePtyIdentity clearWorkspacePtyIdentity',
  ],
  [
    swarm,
    'createSwarmMission getSwarmMissionById registerMissionParticipant listMissionParticipants getVerifiedMissionRecipientBinding createMissionMessage listMissionMessages upsertMessageDelivery listMessageDeliveriesForMission upsertAgentPresence listAgentPresenceForMission getAgentPresenceStatus getSwarmMissionDirectorSnapshot buildTelegramIntentIdempotencyKey getTelegramActorMappingByTelegramUser upsertTelegramActorMapping getTelegramIntentByIdempotencyKey recordTelegramIntentEnvelope upsertTelegramDeliveryReceipt buildTelegramSubscriptionKey upsertTelegramSubscription getLatestTelegramChannelSnapshot getSwarmConfig setSwarmConfig registerSwarmProcess updateSwarmProcess getSwarmProcesses removeSwarmProcess getActiveSwarmCount getActiveAgentCount',
  ],
  [
    tasks,
