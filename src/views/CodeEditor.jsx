...
export default function CodeEditor() {
  ...
  return (
    <div className="core-page-shell flex h-full min-h-0 flex-1 flex-col overflow-hidden">
      <div
        className="sticky top-0 z-10 core-sticky-header flex shrink-0 items-center justify-between border-b px-6 py-2"
