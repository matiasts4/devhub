    ...
    <div className="flex flex-col h-full w-full bg-[#0d0d0d] overflow-hidden">
      ...
      <div className="flex items-end h-[38px] bg-[#1a1a1a] select-none shrink-0 border-b border-[#2a2a2a]">
        <div className="flex-1 overflow-x-auto flex items-end h-full px-2 gap-1 no-scrollbar pt-2">
          ...
          <button
            onClick={addTab}
            className="w-7 h-[30px] flex items-center justify-center hover:bg-white/5 rounded-t-lg text-gray-500 hover:text-gray-300 mt-auto ml-1 transition-colors cursor-pointer"
            title="Nueva pestaña"
          >
        ...
        <div className="flex items-center px-4 gap-2 shrink-0 h-[30px] mt-auto">
          <button
            onClick={onClose}
            className="w-6 h-6 flex items-center justify-center rounded hover:bg-white/10 text-gray-500 hover:text-gray-300 transition-colors cursor-pointer"
