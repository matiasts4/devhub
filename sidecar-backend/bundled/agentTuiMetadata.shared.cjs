...
var agentTuiMetadata_shared_exports = {};
__export(agentTuiMetadata_shared_exports, {
  AGENT_TUI_PATTERN: () => AGENT_TUI_PATTERN,
  AGENT_TUI_TYPES: () => AGENT_TUI_TYPES,
  AgentStateMachine: () => AgentStateMachine,
  detectAgentState: () => detectAgentState,
  detectAgentStateFromOutput: () => detectAgentStateFromOutput,
  detectAgentTypeFromCommand: () => detectAgentTypeFromCommand,
  extractAgentSessionId: () => extractAgentSessionId,
  hasManifest: () => hasManifest,
  isAgentTuiCommand: () => isAgentTuiCommand,
  normalizeAgentCommand: () => normalizeAgentCommand,
  resolveAgentTuiLabel: () => resolveAgentTuiLabel,
  synthesizeAgentSessionId: () => synthesizeAgentSessionId
});
module.exports = __toCommonJS(agentTuiMetadata_shared_exports);
...
function hasManifest(agentType) {
