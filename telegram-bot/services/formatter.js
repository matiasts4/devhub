...
function formatHelp() {
  const lines = [
    ...
    '',
    '*Gestión de sesiones:*',
    '/session — Ver/crear sesión actual',
    '/session new — Forzar nueva sesión',
    '/session info — Detalle con uso de tokens',
    '/session switch <id> — Cambiar sesión',
    '/project — Ver proyecto activo',
