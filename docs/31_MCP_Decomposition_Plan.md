...
La descomposición MCP ya no está en fase de extracción. El baseline vigente es un servidor modular con **36 supported MCP tools** y sin surface pública de Telegram.
...
| Supported contract    | 36 supported MCP tools                                                                    |
