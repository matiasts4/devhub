...
**Jobs del pipeline:**
1. **🔍 lint** — ESLint + verificación de ausencia de archivos fix_*.js y .bak
...
- `.husky/pre-commit` — Corre lint-staged + bloquea archivos de deuda técnica
