# Delta for pizarra-mode-transition

> Modifies the capability as defined in
> `openspec/changes/pizarra-shared-view-state/specs/pizarra-mode-transition/spec.md`
> (the only committed copy — there is no main `openspec/specs/pizarra-mode-transition/spec.md` yet
> because `pizarra-shared-view-state` has not been archived).
