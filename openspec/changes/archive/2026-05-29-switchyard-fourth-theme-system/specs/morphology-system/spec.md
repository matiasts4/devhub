# Delta: Switchyard Fourth Morphology
...
### Requirement: All existing morphologies unchanged after Switchyard integration

The system MUST NOT modify any token values for Default, Brutalist Stage, or Aura morphology blocks. Each MUST produce the same visual output as before this change.

#### Scenario: Brutalist Stage radius unchanged

- GIVEN Brutalist Stage was existing before this change
...
- GIVEN Default was existing before this change
