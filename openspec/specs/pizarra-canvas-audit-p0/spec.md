...
| ------------------------------------------------------- | ------- | -------------- |
| Multi-Select Transformer Anchors                        | Yes     | 3              |
| Circle Stored as Midpoint Center + Half-Diagonal Radius | Yes     | 3              |
| Live Preview During Shape Draw                          | Yes     | 4              |
| One-Time Migration of Stored Circle Shapes              | Yes     | 4              |

**Total**: 4 requirements, 14 scenarios.
