# Spec: board-terminal-drag

> **Source of truth**: promoted from `openspec/changes/pizarra-ux-overhaul/specs/board-terminal-drag/spec.md` on 2026-06-01 (archive of pizarra-ux-overhaul Phase 1).
...
> **Stem rationale**: The hook also covers browser-surface drags (per `PizarraBrowserSurface.jsx`), but the contract is named after its first consumer.
